    ...
    return (
        ...
        <div className="flex flex-col md:flex-row justify-around items-center mb-10 ">
            ...
            <div>
                ...
                <NavLink to='/products'><button className="banner-btn text-2xl font-medium bg-green-950 border-yellow-500 border-[1px] p-2 mr-2 rounded-[20px] mt-5">Order Now</button></NavLink>
            </div>
